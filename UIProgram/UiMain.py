...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于深度学习的小麦病虫害识别软件"))
        ...
        self.label.setText(_translate("MainWindow", "总目标数:"))
        self.label_5.setText(_translate("MainWindow", "目标选择:"))
        self.label_10.setText(_translate("MainWindow", "检测用时:"))
        self.label_11.setText(_translate("MainWindow", "置信度:"))
        self.label_13.setText(_translate("MainWindow", "类型:"))
        self.show_labels_and_conf.setText(_translate("MainWindow", "标签名称与置信度"))
        self.groupBox_4.setTitle(_translate("MainWindow", "操作"))
        self.SaveBtn.setText(_translate("MainWindow", "保存结果"))
        self.ExitBtn.setText(_translate("MainWindow", "模型训练"))
        self.VideoBtn.setText(_translate("MainWindow", "上传视频"))
        self.CapBtn.setText(_translate("MainWindow", "实时识别"))
        self.PicBtn.setText(_translate("MainWindow", "单图识别"))
        self.FilesBtn.setText(_translate("MainWindow", "多图识别"))
        ...
        self.label_3.setText(_translate("MainWindow", "基于深度学习的小麦病虫害识别软件"))
